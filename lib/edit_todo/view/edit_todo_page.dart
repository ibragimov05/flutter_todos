...
class EditTodoPage extends StatelessWidget {
  ...
  static Route<void> route({Todo? initialTodo}) => CupertinoPageRoute(
...
class _TitleField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      onChanged: (title) =>
          context.read<EditTodoBloc>().add(EditTodoTitleChanged(title: title)),
    );
  }
}
...
class _DescriptionField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      onChanged: (description) => context.read<EditTodoBloc>().add(
